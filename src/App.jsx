...
function App() {
	...
	return (
		<div className="min-h-screen background_img">
			<div className="mx-auto px-4 py-6 max-w-7xl">
				...
				{trendingMovies.length > 0 && (
					<section className="mb-8 lg:mb-12 ">
						...
						<div className="w-full backdrop-blur-sm rounded-2xl p-4 md:p-6 overflow-x-auto overflow-y-hidden scroll-smooth snap-x snap-mandatory [-webkit-overflow-scrolling:touch]">
							<div className="flex w-max gap-4 lg:mx-auto">
								{trendingMovies.map((movie, index) => (
									<div
										key={movie.$id}
										className="relative group shrink-0 snap-center snap-always"
									>
										<div className="absolute top-0 left-0 w-5 h-5 md:w-10 md:h-10 rounded-br-2xl bg-gradient-to-br from-yellow-400 to-orange-500 text-gray-800 shadow-lg flex items-center justify-center z-10 text-xs md:text-sm font-extrabold">
											{index + 1}
										</div>
